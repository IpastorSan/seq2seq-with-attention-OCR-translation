...
"""#3) OCR for inputting text in Chinese"""

#Pre-trained files in simplified and traditional Chinese--Tesseract
#Obtain any of these files here: https://github.com/tesseract-ocr/tessdata
...
"""##3.1 Import image as string"""

from PIL import Image
from pytesseract import image_to_string

"""Each image gets imported as a separate character, we will unite all and tokenize with jieba

Preprocessing:
1)Eliminate all spaces
2)Apply initial preprocessing function
"""
...
def from_image_to_text(image):
    ...
    text = re.sub(" ", "", text_im) #Eliminating spaces to apply pre-processing
    return text

"""##3.2 Translate image content"""
